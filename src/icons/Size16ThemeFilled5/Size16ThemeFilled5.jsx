...
export const Size16ThemeFilled5 = ({ className }) => {
  return (
    <svg
      className={`size-16-theme-filled-5 ${className}`}
      fill="none"
      height="16"
      viewBox="0 0 16 16"
      width="16"
