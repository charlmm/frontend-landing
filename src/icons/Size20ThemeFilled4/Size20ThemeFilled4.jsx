...
export const Size20ThemeFilled4 = ({ className }) => {
  return (
    <svg
      className={`size-20-theme-filled-4 ${className}`}
      fill="none"
      height="20"
      viewBox="0 0 20 20"
      width="20"
