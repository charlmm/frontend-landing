...
export const Size24ThemeFilled4 = ({ className }) => {
  return (
    <svg
      className={`size-24-theme-filled-4 ${className}`}
      fill="none"
      height="24"
      viewBox="0 0 24 24"
      width="24"
