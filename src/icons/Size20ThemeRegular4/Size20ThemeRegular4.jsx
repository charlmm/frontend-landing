...
export const Size20ThemeRegular4 = ({ color = "#212121", className }) => {
  return (
    <svg
      className={`size-20-theme-regular-4 ${className}`}
      fill="none"
      height="20"
      viewBox="0 0 20 20"
      width="20"
